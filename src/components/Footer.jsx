        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-full md:w-4/12 mb-8 md:mb-0">
            <div className="flex items-center mb-4">
              <img src="/tecken-logo-black.svg" alt="Logo" className="h-10 w-10 mr-2" />
              <span className="text-xl font-bold">Tecken</span>
              <span className="text-sm text-gray-600 ml-2 mt-[2px]">Signs & Graphics</span>
            </div>
            <p className="text-gray-600 mb-4 max-w-sm">
              Creating high-quality, custom signage and graphic solutions for businesses.
