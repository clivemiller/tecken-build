    ...
    <footer className="bg-gray-100 text-gray-800 pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap">
          ...
          {/* Newsletter */}
          <div className="w-full md:w-3/12 mb-8 md:mb-0">
            <h4 className="text-lg font-bold mb-4 text-gray-900">Newsletter</h4>
            <p className="text-gray-600 mb-4">Subscribe to our newsletter to receive updates and special offers.</p>
            <form className="flex flex-col space-y-2">
              <input 
                type="email"
                placeholder="Your email address"
                className="px-4 py-2 rounded-md bg-gray-200 border border-gray-300 text-gray-800 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent"
              />
              <button 
                type="submit"
        ...
        <div className="border-t border-gray-200 mt-10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              ...
              <a href="#" className="text-gray-600 hover:text-black text-sm transition-colors">Sitemap</a>
            </div>
          </div>
        </div>
      </div>
